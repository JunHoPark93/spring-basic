...
public class BoardDAO {
    ...
    public void updateBoard(BoardVO vo) {
        System.out.println("jdbc로 updateBoard처리");
    ...
    public void deleteBoard(BoardVO vo) {
        System.out.println("jdbc로 deleteBoard처리");
    ...
    public BoardVO getBoard(BoardVO vo) {
        System.out.println("jdbc로 getBoard처리");
        BoardVO board = null;
    ...
    public List<BoardVO> getBoardList(BoardVO vo) {
        System.out.println("jdbc로 getBoardList처리");
